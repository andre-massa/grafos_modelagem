...
def modelo_anexacao_uniforme(rede_inicial, num_novos_nos, criterio_ligacoes):
    ...
    for i in range(num_novos_nos):
        ...
        # Sorteia a quantidade de ligações para o novo nó
        ...
        # Escolhe os nós para conectar de forma uniforme e aleatória
...
# --- Bloco Principal de Execução (estilo interativo) ---

print("--- Configuração do Modelo de Anexação Uniforme ---")
# Pergunta ao usuário os parâmetros da rede
...
# (i) Rede Inicial: Criando uma rede inicial pequena e conectada
rede_inicial = nx.complete_graph(num_nos_iniciais)
print(f"\nRede inicial criada com {rede_inicial.number_of_nodes()} nós e {rede_inicial.number_of_edges()} arestas.")

# Gera a rede final
print("Gerando a rede final...")
G = modelo_anexacao_uniforme(rede_inicial, num_novos_nos, media_ligacoes)
print("Rede final gerada com sucesso!")

# Visualização do Grafo da Rede
print("Exibindo o grafo da rede...")
...
# Visualização da Distribuição de Graus
print("Exibindo a distribuição de graus...")
...
# Medidas Descritivas
print("\n--- Medidas Descritivas da Rede Final ---")
